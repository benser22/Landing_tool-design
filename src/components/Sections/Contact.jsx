      ...
      <div className="flex flex-col justify-center items-center py-12 px-8 gap-2 bg-fucsia_Custom text-white">
        ...
        <div className="flex flex-col sm:flex-row items-center mt-4 gap-2 w-full justify-center">
          <input
            ...
            className="min-w-[280px] text-white bg-blue-gray_Custom p-3 px-2 border-none rounded-md border placeholder-[#DADADD]"
            placeholder={data['section-contact'].input_placeholder}
          />
          <button
            className="rounded-md bg-amber_Custom text-blue-gray_Custom p-3 px-6 hover:brightness-105 active:brightness-95 transition-all"
